...
def _prompt_ocr(tipo: str, is_portrait: bool = False) -> str:
    ...
    return (
        "Esta é uma foto de um hidrômetro de ÁGUA circular. "
        "Pode ser marca Renova UR-3.0 (apartamentos) ou LAO (medidor geral do prédio).\n\n"
        "ESTRUTURA — RENOVA UR-3.0 (corpo circular preto, tampa basculante aberta à esquerda):\n"
        "  - FAIXA DE ROLETES no centro-esquerda da face, à esquerda do símbolo 'm³'.\n"
        "  - Um mostrador analógico giratório à direita (ponteiro vermelho, escala 0-9) — IGNORE.\n"
        "  - Tampa aberta com sticker QR code e serial (ex: 'A23R012062') — IGNORE.\n\n"
        "ESTRUTURA — LAO (corpo circular metálico/bronze, sem tampa basculante):\n"
        "  - FAIXA DE ROLETES no TOPO da face, abaixo do logo 'LAO'.\n"
        "  - Código de barras na face com serial (ex: 'L17000092') — IGNORE.\n"
        "  - Código de modelo ao lado dos roletes (ex: 'MJ 9B6') — IGNORE.\n"
        "  - DOIS mostradores analógicos abaixo dos roletes (ponteiros vermelhos, X0.01 e X0.001) — IGNORE.\n"

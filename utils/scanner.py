...
class ScannerAguaFlow:
    ...
    async def iniciar_scan(self, tipo="Água"):
        ...
        try:
            await self.picker.pick_files(allow_multiple=False, file_type=ft.FilePickerFileType.IMAGE)
    ...
    async def _processar_resultado(self, e: ft.FilePickerResultEvent):
        ...
        try:
            ...
            # Se o OCR demorar mais de 10s, ele cancela e habilita o modo manual
            ...
            await self.ao_detectar_leitura(None, "", False) # Libera manual
